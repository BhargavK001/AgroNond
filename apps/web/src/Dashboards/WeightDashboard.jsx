            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100">
               <div>
                  ...
                  <span className={`px-3 py-1 rounded-full text-sm font-bold inline-flex items-center gap-2 ${
                    selectedRecord.status === 'Done' ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'
                  }`}>
               ...
               {selectedRecord.updated_weight && (
                 <div className="flex justify-between py-3">
                   ...
                   <span className={`font-bold ${
                     selectedRecord.updated_weight >= selectedRecord.est_weight ? 'text-green-600' : 'text-red-500'
                   }`}>
