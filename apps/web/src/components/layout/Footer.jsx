          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="space-y-4">
                ...
                <a href="https://agronond.khomrajthorat.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-300 hover:text-green-400 transition-colors">
                  <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                    </svg>
                  </div>
                  <span className="text-sm">agronond.khomrajthorat.com</span>
                </a>
              </div>
            </div>
        ...
        <div className="container">
          <div className="py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <p className="text-gray-500 text-sm flex items-center gap-1">
              Made with <span className="text-green-500">🌱</span> for Indian Farmers
            </p>
          </div>
        </div>
      </div>
