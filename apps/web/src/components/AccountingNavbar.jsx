...
// Navigation Tabs
const navTabs = [
  { label: 'Dashboard', path: '/dashboard/accounting' },
  { label: 'Transactions', path: '/dashboard/accounting/transactions' },
  { label: 'Traders', path: '/dashboard/accounting/traders' },
  { label: 'Farmers', path: '/dashboard/accounting/farmers' },
...
export default function AccountingNavbar() {
  ...
  const [profile, setProfile] = useState({
    ...
    email: 'accounts@agronond.com',
    location: 'Pune APMC',
    role: 'Head Accountant',
    photo: '',
    accountingId: 'ACC-2026-001',
    initials: 'AU'
  });
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-8">
            <Link to="/dashboard/accounting" className="flex items-center gap-2 group shrink-0">
              ...
              <div className="hidden sm:block">
                ...
                <span className="block text-[10px] text-emerald-600 font-bold uppercase tracking-wider">Accounting Portal</span>
              </div>
            </Link>
          </div>
            ...
            {navTabs.map((tab) => {
              ...
              return (
                ...
                >
                  {isActive && (
                    <motion.div
                      layoutId="activeAccountingNavTab"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                {profile.photo ? (
                  <img src={profile.photo} alt="Profile" className="w-9 h-9 rounded-full object-cover shadow-sm border border-emerald-100" />
                ) : (
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-500 to-green-600 text-white flex items-center justify-center font-bold shadow-sm text-sm">
                    {profile.initials}
                  </div>
                )}
                      ...
                      {!isEditing ? (
                        ...
                        >
                          ...
                          <div className="p-6 bg-slate-50 border-b border-slate-100 text-center">
                            ...
                            <div className="flex items-center justify-center gap-1 mt-2 bg-emerald-50 py-1 px-3 rounded-full mx-auto w-fit border border-emerald-100">
                              <span className="text-xs font-bold text-emerald-700">{profile.accountingId}</span>
                        ...
                        >
                          <div className="p-4 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <button onClick={() => setIsEditing(false)} className="p-1 hover:bg-slate-100 rounded-lg text-slate-400">
                              <X size={18} />
                            </button>
                          </div>
                          ...
                          <div className="p-6 space-y-5 overflow-y-auto max-h-[400px]">
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                <label className="block text-xs font-semibold text-slate-600 mb-1">Staff ID <span className="text-emerald-600 text-[10px] font-normal">(Read Only)</span></label>
                                <div className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-500 font-medium flex items-center justify-between">
                                  {profile.accountingId}
                          ...
                          <div className="p-4 border-t border-slate-100 flex gap-3">
                            ...
                            <button
                              onClick={handleSave}
                              className="flex-1 px-4 py-2 text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-700 rounded-lg flex items-center justify-center gap-2 shadow-sm transition-colors"
                            >
                              <Save size={16} />
                              Save Changes
                            </button>
                ...
                {navTabs.map((tab) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`block px-4 py-3 rounded-lg text-sm font-medium ${isActive
                        ? 'bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-md mx-2'
