...
export default function AccountingNavbar({ onMenuClick }) {
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-sm">
              <span className="text-slate-500 hidden sm:inline">Accounting</span>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <div className="hidden md:block">
              <UniversalSearch placeholder="Search invoices, users..." />
            </div>
            <NotificationCenter />
                      ...
                      {!isEditing ? (
                        <motion.div key="view" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                          <div className="p-6 bg-gradient-to-br from-slate-50 to-slate-100 border-b border-slate-200 text-center">
                            ...
                            <div className="inline-flex items-center gap-1.5 mt-2 bg-emerald-100 py-1 px-3 rounded-full"><span className="text-xs font-bold text-emerald-700">{profile.accountingId}</span></div>
                          </div>
